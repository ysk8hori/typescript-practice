...
describe('maybe', () => {
  ...
  describe('nullish', () => {
    ...
    test('getOrElse', () => expect(nullish().getOrElse(10000)).toBe(10000));
    test('chain', () =>
    ...
    test('getOrElse', () => expect(nullish().isJust()).toBeFalsy());
    test('getOrElse', () => expect(nullish().isNothing()).toBeTruthy());
  });
  describe('numberish', () => {
    test('toEqual', () =>
    ...
    test('getOrElse', () => expect(numberish().getOrElse(10000)).toBe(1));
    test('chain', () =>
      expect(numberish().chain(toIo).toString()).toEqual(
        'IO([object Object])'
      ));
    test('filter(withoutNull)', () => {
    ...
    test('getOrElse', () => expect(numberish().isJust()).toBeTruthy());
    test('getOrElse', () => expect(numberish().isNothing()).toBeFalsy());
  });
});
